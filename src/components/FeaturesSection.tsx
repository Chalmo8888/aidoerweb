...
import { MessageSquare, Repeat, Layers, Brain, Check, Zap } from 'lucide-react';
  ...
  return <section id="features" className="py-24 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-5xl mx-auto">
          {features.map((feature, index) => <div key={index} className="group glass-strong rounded-2xl p-6 hover-lift relative overflow-hidden" style={{
              ...
              <div className="relative z-10">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    {feature.subtitle && <span className="text-sm text-primary font-medium">{feature.subtitle}</span>}
                  </div>
                </div>

                <p className="text-muted-foreground mb-5 text-sm leading-relaxed">{feature.desc}</p>

                <ul className="space-y-3 mb-5">
                  {feature.items.map((item, i) => <li key={i} className="flex items-center gap-3">
