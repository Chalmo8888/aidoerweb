        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-12">
            {problems.map((problem, index) => (
              <div
                key={index}
                className="group glass-strong rounded-2xl p-6 flex items-center gap-4 hover-lift"
              >
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-4">
                {issues.map((issue, index) => (
                  <div key={index} className="flex items-center gap-4 p-3 rounded-xl bg-destructive/5 hover:bg-destructive/10 transition-colors">
