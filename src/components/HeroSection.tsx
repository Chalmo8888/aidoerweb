      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 glass-strong px-4 py-2 rounded-full mb-8 animate-fade-in">
            ...
            <p 
              className="text-lg text-muted-foreground mb-8 leading-relaxed max-w-xl mx-auto lg:mx-0 animate-fade-in"
            ...
            >
              <Button 
                size="lg" 
                className="group bg-gradient-primary hover:opacity-90 transition-all duration-300 shadow-glow hover:shadow-glow-lg px-8 h-14 text-base"
          ...
          >
            ...
            {/* Floating elements */}
            <div className="absolute top-10 right-10 glass-strong p-3 rounded-xl float" style={{ animationDelay: '1s' }}>
